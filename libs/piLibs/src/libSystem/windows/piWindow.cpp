...
piWindowMessage::MessageResponse piWindowMessage::Prompt(const wchar_t *caption, const wchar_t *message, MessageType type, MessageIcon icon)
{
    int flags = 0;
    ...
    const int res = MessageBox( 0, message, caption, flags );
